...
import { useAddRouteMutation } from "../../services/api";
import dayjs from "dayjs";

export const SaveRouteButton: FC = () => {
  ...
  const [addRoute, { isLoading: isSaving, reset }] = useAddRouteMutation();
  ...
  const saveRoute = async () => {
    ...
    const res = await addRoute(body).unwrap();
